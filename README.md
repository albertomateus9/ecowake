...
Conceito de plataforma aplicada de IA e dados para monitoramento preditivo em operacoes maritimas.

**Demo:** https://albertomateus9.github.io/ecowake/

## Visão Geral

EcoWake é um projeto de vitrine do portfólio técnico de Alberto Mateus P. da Gama. O objetivo é demonstrar maturidade profissional em redes, telecomunicações, automação, educação tecnológica e sistemas aplicados.
